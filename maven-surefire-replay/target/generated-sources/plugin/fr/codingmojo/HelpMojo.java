...
/**
 * Display help information on maven-surefire-replay.<br/> Call <pre>  mvn maven-surefire-replay:help -Ddetail=true -Dgoal=&lt;goal-name&gt;</pre> to display parameter details.
 *
 * @version generated on Thu Dec 01 23:15:29 CET 2011
    ...
    extends AbstractMojo
{
        ...
        throws MojoExecutionException
    {
        ...
        append( sb, "fr.codingmojo:maven-surefire-replay:0.0.1-SNAPSHOT", 0 );
        append( sb, "", 0 );

        append( sb, "maven-surefire-replay Maven Plugin", 0 );
        ...
        {
            append( sb, "maven-surefire-replay:help", 0 );
            append( sb, "Display help information on maven-surefire-replay.\nCall\n\u00a0\u00a0mvn\u00a0maven-surefire-replay:help\u00a0-Ddetail=true\u00a0-Dgoal=<goal-name>\nto display parameter details.", 1 );
            append( sb, "", 0 );
            if ( detail )
            {
        ...
        if ( goal == null || goal.length() <= 0 || "replay".equals( goal ) )
        {
            append( sb, "maven-surefire-replay:replay", 0 );
